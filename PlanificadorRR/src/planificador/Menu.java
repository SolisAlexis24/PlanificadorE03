        ...
        while (continuar) {
            ...
            switch (opcion) {
                case 1 -> {
                    ...
                    Proceso procesoaux = new Proceso(contador);
                    ...
                    procesoaux.setTiempoLlegada(tiempoLlegada);

                    Planificador.Procesos.add(proceso);
                    Planificador.ProcesosAux.add(procesoaux);
                    System.out.println("");
                }
                case 2 -> {
